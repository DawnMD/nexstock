...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:fill-mode-forwards fixed inset-0 z-50 bg-black/50 duration-200",
        className,
      )}
      {...props}
    />
