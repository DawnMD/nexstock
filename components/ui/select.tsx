...
// Bare re-export: `Select.Root.Props` is generic over <Value, Multiple>, which
// breaks the usual wrapper-function pattern.
...
function SelectContent({
  ...
  side,
  sideOffset,
  // Radix `position="popper"` is this wrapper's historical default.
